...
public class NC_Wait_FSMRBS : NC_BaseState_FSM
{
    ...
    public override Type StateEnter()
    {
        ...
        nC_SmartTank_FSM.TankStop(); // Stop the tank
        return null;
    }
    public override Type StateUpdate()
    {
        ...
        if (timer >= waitTime)
        {
            return typeof(NC_PatrolState_FSM); // After waiting, switch to patrol state
        }
    ...
    public override Type StateExit()
    {
        ...
        nC_SmartTank_FSM.TankGo(); // Resume tank movement on exiting the state
        return null;
    }
}